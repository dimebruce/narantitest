...
<head>
  ...
  <title>Biblioteca | Naranti</title>
...
$('.table').on('click', '.eliminarSocio', function(){

var socioId = $(this).attr('socioId');
var Socio = $(this).attr('Socio');

Swal.fire({

    title: '¿Desea eliminar el socio '+Socio+'?',
    icon: 'warning',
    ...
    if(result.isConfirmed){
        ...
        window.location = "{{ url('eliminarSocio/') }}/"+socioId;
...
@if(session('SocioCreado') == 'OK')

<script type="text/javascript">

    Swal.fire(

        'El socio ha sido creado',
        '',
        'success'
...
@elseif(session('socioActualizado') == 'OK')
